  ...
  Widget build(BuildContext context) {
    ...
    new Align(
      ...
      child: new IgnorePointer(
        ...
        size: new Size(MediaQuery.of(context).size.width * 0.8,
    ...
    new Align(
      ...
      child: new IgnorePointer(
          child: new SizedBox.fromSize(
        size: new Size(MediaQuery.of(context).size.width * 0.85,
    ...
    new Align(
      ...
      child: new Draggable(
        feedback: new SizedBox.fromSize(
          size: new Size(MediaQuery.of(context).size.width * 0.9,
